...
class _CreateEventState extends State<CreateEvent>{
  ...
  int _maxAttendees = 0; // Default value
  DateTime _selectedDate = DateTime.now();
  String formattedDate = '';// Default date
  int costMoney = 0;
  String paymentInfo = '';
        ...
        children: [
          TextFormField(
            ...
            decoration: InputDecoration(
              label: Text('Titel'),
              errorText: _validateName ? 'Skriv ett namn på evenemanget' : null,
            ),
            onChanged: (value) {
              name = value;
            },
          ...
          DateTimeFormField(
            decoration: InputDecoration(
              labelText: 'Datum & tid:',
              errorText: _validateDateTime ? 'Välj datum och tid' : null,
            ),
            ...
            child: ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        formattedDate.isEmpty ? _validateDateTime = true : _validateDateTime = false;
        ...
        content: Container(
          child: Column(
              children: [
                ...
                RadioListTile(
                  value: 'true', groupValue: hasLimitedSpots,  onChanged: (value) {
                  setState(() {
                ...
                RadioListTile(
                    value: 'false', groupValue: hasLimitedSpots, onChanged: (value) {
                  setState(() {
                ...
                Text('Pris?'),
                RadioListTile(
                  value: 'true', groupValue: doCostMoney,  onChanged: (value) {
                  setState(() {
                    doCostMoney = 'true';
                ...
                RadioListTile(
                    value: 'false', groupValue: doCostMoney, onChanged: (value) {
                  setState(() {
                    doCostMoney = 'false';
                    costMoney = 0;
                    paymentInfo = '';
                          ...
                          child: ElevatedButton(onPressed: () {
                            setState(() {
                              ...
                              if(hasLimitedSpots == 'true') {
                                limitedSpotsController.text.isEmpty ? _validateSpots = true : _validateSpots = false;
                              }
                              if(doCostMoney == 'true') {
                                costMoneyController.text.isEmpty ? _validateMoney = true : _validateMoney = false;
                              }
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText: _validateStreetAddress ? 'Skriv en adress' : null,
                  ),
                  onChanged: (value) {
                    setState(() {
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText: _validateStreetAddress ? 'Skriv ett postnummer' : null,
                  ),
                  onChanged: (value) {
                    setState(() {
                      streetAddress = streetController.text;
                      ...
                      Align(alignment: Alignment.bottomCenter,
                        child: ElevatedButton(onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Preview(
                              name: name, dateTime: _selectedDate,
                              description: description, maxAttendees: _maxAttendees, cost: costMoney, paymentInfo: paymentInfo)));
                        }, style: ElevatedButton.styleFrom(
                              fixedSize: const Size(125, 30),
                            ),
                            child: Text("Nästa")
